document.addEventListener('DOMContentLoaded', () => {
    ...
    const historyAppStatsList = document.getElementById('history-app-stats') as HTMLElement;
    ...
    function displayHistoryAppUsage(apps: DailyAppStats[]) {
    ...
    async function loadDailyAppStats(date: string) {
